...
if(isset($_POST['update_slider']))
{
	...
	$slider_heading=$_POST['slider_heading'];
	$is_active=($_POST['is_active']!='' ? 1 : 2);


	if(!empty($_FILES['slider_img']['name']))
	{
		$slider_img='img_'.rand(0,1000).'_'.$_FILES['slider_img']['name'];
	}
	else
	{
		$slider_img=$_POST['slider_img_hidden'];
	}
	
   

    $query=mysqli_query($conn,"update tbl_slider
    	                                             SET slider_img='$slider_img',
    ...
    if($query)
    {
    	if(!empty($_FILES['slider_img']['name']))
	{
    	move_uploaded_file($_FILES['slider_img']['tmp_name'], 'images/slider/'.$slider_img.'');
    	unlink('images/slider/'.$_POST['slider_img_hidden']);
    }
...
$details=mysqli_fetch_array(mysqli_query($conn,"select * from tbl_slider where slider_id=$edit_id"));
?>
	<!--begin::Body-->
				...
				<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Slider</h5>
									<!--end::Page Title-->
...
<input type="file" name="slider_img" value="" class="form-control">
<?php if(!empty($details['slider_img'])){?>
<img src="<?=BASE_URL_IMG?>slider/<?=$details['slider_img']?>" width='50' class="mt-3">
<?php }?>
<input type="hidden" name="slider_img_hidden" value="<?=$details['slider_img']?>">
</div>
...
<span class="text-danger">*</span></label>
<input type="text" name="slider_heading" value="<?=$details['slider_heading']?>" class="form-control" autocomplete="off" placeholder="Heading">
</div>
