...
if(isset($_POST['add_slider']))
{
    ...
    $query=mysqli_query($conn,"insert into tbl_slider
				...
				<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Slider</h5>
									<!--end::Page Title-->
...
<span class="text-danger">*</span></label>
<input type="text" name="slider_heading" value="" class="form-control" autocomplete="off" placeholder="Heading">
</div>
