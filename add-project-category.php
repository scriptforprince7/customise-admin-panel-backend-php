...
if(isset($_POST['add_slider']))
{
	...
	if(count($err)==0)
	{
			$query=mysqli_query($conn,"insert into tbl_prj_cat
				...
				<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Project Slider</h5>
									<!--end::Page Title-->
...
<input type="text" name="prj_cat_name" value="" class="form-control" autocomplete="off" placeholder="Category Name">
</div>
