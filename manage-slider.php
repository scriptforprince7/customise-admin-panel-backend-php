...
if(isset($_GET['del']))
{
	...
	$slider_id=$_GET['del'];
	$img_name=mysqli_fetch_array(mysqli_query($conn,"select * from tbl_slider where slider_id=$slider_id"));
    unlink('images/slider/'.$img_name['slider_img']);
	$query=mysqli_query($conn,"delete from tbl_slider where slider_id=$slider_id");
	if($query)
	{
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Manage Slider</h5>
									<!--end::Page Title-->
...
<table id="example" class="table table-bordered  dataTable " style="width:100%">
	  ...
	  if($totl>0)
	{
	  ...
	  ?>
		...
		<td><a href="<?=BASE_URL?>view-slider.php?view_id=<?=$row['slider_id']?>" >View</a></td>
		...
		<td><a href="<?=BASE_URL?>edit-slider.php?edit_rec=<?=$row['slider_id']?>" class="btn btn-warning">Edit</a></td>
		<td><a href=""  class="btn btn-danger del_rec" data-url="<?=BASE_URL?>manage-slider.php?del=<?=$row['slider_id']?>">Delete</a></td>
		</tr>
	  <?php $id++;}}else{?>
	  	<tr>
