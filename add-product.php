...
<input type="text" name="prod_name" value="<?=$prod_name?>" placeholder="Name" class="form-control">
</div>
...
<span class="text-danger">*</span></label>
<input type="text" name="prod_img_alt_tag" value="<?=$prod_img_alt_tag?>" placeholder="Image Alt Tag" class="form-control">
</div>
...
<button type="submit" name="add_product" class="btn btn-primary mr-2">Add</button>
