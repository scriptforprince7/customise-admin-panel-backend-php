...
if(isset($_POST['update_project_image']))
{
	...
	{
		$prj_img_name='img_'.rand(0,1000).'_'.$_FILES['prj_img_name']['name'];
	}
	else
	{
    ...
    if($query)
    {
    	if(!empty($_FILES['prj_img_name']['name']))
	{
    	move_uploaded_file($_FILES['prj_img_name']['tmp_name'], 'images/project-image/'.$prj_img_name.'');
    	unlink('images/project-image/'.$_POST['prj_img_name_hidden']);
    }
    	header('Location:manage-project-image.php');
    }
}


$details=mysqli_fetch_array(mysqli_query($conn,"select * from tbl_prj_img where prj_img_id=$edit_id"));
				...
				<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Project Image</h5>
									<!--end::Page Title-->
...
<!--begin::Button-->
<a href="<?=BASE_URL?>manage-project-image.php" class="btn btn-primary font-weight-bolder">
...
<span class="text-danger">*</span></label>
<input type="file" name="prj_img_name" value="" class="form-control">
<?php if(!empty($details['prj_img_name'])){?>
<img src="<?=BASE_URL_IMG?>project-image/<?=$details['prj_img_name']?>" width='50' class="mt-3">
<?php }?>
<input type="hidden" name="prj_img_name_hidden" value="<?=$details['prj_img_name']?>">
</div>
...
<button type="submit" name="update_project_image" class="btn btn-primary mr-2">Update</button>
