...
if(isset($_GET['del']))
{
	...
	$prod_id=$_GET['del'];
	$img_name=mysqli_fetch_array(mysqli_query($conn,"select * from tbl_product where prod_id=$prod_id"));
    unlink('images/product/'.$img_name['prod_img']);
	$query=mysqli_query($conn,"delete from tbl_product where prod_id=$prod_id");
	if($query)
	{
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Manage Product</h5>
									<!--end::Page Title-->
...
<li class="navi-item">
<a href="<?=BASE_URL?>export-product.php" class="navi-link">
...
<a href="<?=BASE_URL?>add-product.php" class="btn btn-primary font-weight-bolder">
<span class="svg-icon svg-icon-md">
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
<rect x="0" y="0" width="24" height="24"></rect>
...
<table id="example" class="table table-bordered  dataTable " style="width:100%">
	  ...
	  if($totl>0)
	{
	  ...
	  ?>
		...
		<td><?=$id?></td>
		<td><?=$row['prod_name']?></td>
		<td><img src="<?=BASE_URL_IMG.'product/'.$row['prod_img'].''?>" width="100"></td>
		...
		<td><a href="<?=BASE_URL?>edit-product.php?edit_rec=<?=$row['prod_id']?>" class="btn btn-warning">Edit</a></td>
		<td><a href=""  class="btn btn-danger del_rec" data-url="<?=BASE_URL?>manage-product.php?del=<?=$row['prod_id']?>">Delete</a></td>
		</tr>
	  <?php $id++;}}else{?>
	  	<tr>
